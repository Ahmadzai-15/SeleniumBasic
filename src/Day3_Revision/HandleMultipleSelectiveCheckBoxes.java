...
public class HandleMultipleSelectiveCheckBoxes {
    public static void main(String[] args) {
        ...
        for (WebElement day:days){
            if(day.getAttribute("id").equalsIgnoreCase("tuesday")||day.getAttribute("id").equalsIgnoreCase("saturday")||day.getAttribute("id").equalsIgnoreCase("thursday")){
             day.click();
            }
        }
    }
